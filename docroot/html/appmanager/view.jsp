...
.color1{
	background: linear-gradient(#9FC6E7, #62a2d8);
}
.color1-tick{
	background-image: url("<%=request.getContextPath()%>/images/tick.png"), linear-gradient(#9FC6E7, #62a2d8);
}
.color2{
	background: linear-gradient(#5484ED, #1755dd);
}
.color2-tick{
	background-image: url("<%=request.getContextPath()%>/images/tick.png"), linear-gradient(#5484ED, #1755dd);
}
.color3{
	background: linear-gradient(#A4BDFC, #5a87fa);
}
.color3-tick{
	background-image: url("<%=request.getContextPath()%>/images/tick.png"), linear-gradient(#A4BDFC, #5a87fa);
}
.color4{
	background: linear-gradient(#51B749, #398133);
}
.color4-tick{
	background-image: url("<%=request.getContextPath()%>/images/tick.png"), linear-gradient(#51B749, #398133);
}
.color5{
	background: linear-gradient(#FBD75B, #f9c510);
}
.color5-tick{
	background-image: url("<%=request.getContextPath()%>/images/tick.png"), linear-gradient(#FBD75B, #f9c510);
}
.color6{
	background: linear-gradient(#FFB878, #ff902c);
}
.color6-tick{
	background-image: url("<%=request.getContextPath()%>/images/tick.png"), linear-gradient(#FFB878, #ff902c);
}
.color7{
	background: linear-gradient(#FF887C, #ff4330);
}
.color7-tick{
	background-image: url("<%=request.getContextPath()%>/images/tick.png"), linear-gradient(#FF887C, #ff4330);
}
.color8{
	background: linear-gradient(#DC2127, #99171b);
}
.color8-tick{
	background-image: url("<%=request.getContextPath()%>/images/tick.png"), linear-gradient(#DC2127, #99171b);
}
.color9{
	background: linear-gradient(#DBADFF, #b961ff);	
}
.color9-tick{
	background-image: url("<%=request.getContextPath()%>/images/tick.png"), linear-gradient(#DBADFF, #b961ff);
}
.color10{
	background: linear-gradient(#E1E1E1, #bbbbbb);
}
.color10-tick{
	background-image: url("<%=request.getContextPath()%>/images/tick.png"), linear-gradient(#E1E1E1, #bbbbbb);
}
