...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"lfvo-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "lfvo-portlet";
			}
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"net.indaba.lostandfound.exception.NoSuchItemException")) {
			return new net.indaba.lostandfound.exception.NoSuchItemException(throwable.getMessage(),
				throwable.getCause());
		}
