...
public class ItemUtil {
	...
	*/
	public static List<Item> findByUuid(java.lang.String uuid) {
	...
	*/
	public static List<Item> findByUuid(java.lang.String uuid, int start,
		int end) {
	...
	*/
	public static Item findByUuid_First(java.lang.String uuid,
	...
	*/
	public static Item fetchByUuid_First(java.lang.String uuid,
		OrderByComparator<Item> orderByComparator) {
	...
	* @throws NoSuchItemException if a matching item could not be found
	*/
	public static Item findByUuid_Last(java.lang.String uuid,
		OrderByComparator<Item> orderByComparator)
		throws net.indaba.lostandfound.exception.NoSuchItemException {
	...
	*/
	public static Item fetchByUuid_Last(java.lang.String uuid,
		OrderByComparator<Item> orderByComparator) {
	...
	*/
	public static Item[] findByUuid_PrevAndNext(long itemId,
		java.lang.String uuid, OrderByComparator<Item> orderByComparator)
		throws net.indaba.lostandfound.exception.NoSuchItemException {
		return getPersistence()
	...
	* @throws NoSuchItemException if a matching item could not be found
	*/
	public static Item findByUUID_G(java.lang.String uuid, long groupId)
		throws net.indaba.lostandfound.exception.NoSuchItemException {
	...
	*/
	public static Item fetchByUUID_G(java.lang.String uuid, long groupId) {
	...
	*/
	public static Item removeByUUID_G(java.lang.String uuid, long groupId)
		throws net.indaba.lostandfound.exception.NoSuchItemException {
	...
	* @return the matching items
	*/
	public static List<Item> findByUuid_C(java.lang.String uuid, long companyId) {
	...
	* @return the range of matching items
	*/
	public static List<Item> findByUuid_C(java.lang.String uuid,
	...
	* @throws NoSuchItemException if a matching item could not be found
	*/
	public static Item findByUuid_C_First(java.lang.String uuid,
	...
	* @return the first matching item, or <code>null</code> if a matching item could not be found
	*/
	public static Item fetchByUuid_C_First(java.lang.String uuid,
		long companyId, OrderByComparator<Item> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchItemException if a matching item could not be found
	*/
	public static Item findByUuid_C_Last(java.lang.String uuid, long companyId,
		OrderByComparator<Item> orderByComparator)
		throws net.indaba.lostandfound.exception.NoSuchItemException {
		return getPersistence()
	...
	* @return the last matching item, or <code>null</code> if a matching item could not be found
	*/
	public static Item fetchByUuid_C_Last(java.lang.String uuid,
		long companyId, OrderByComparator<Item> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchItemException if a item with the primary key could not be found
	*/
	public static Item[] findByUuid_C_PrevAndNext(long itemId,
	...
	* @return the matching items
	*/
	public static List<Item> findByGroupId(long groupId) {
	...
	* @return the range of matching items
	*/
	public static List<Item> findByGroupId(long groupId, int start, int end) {
	...
	* @throws NoSuchItemException if a matching item could not be found
	*/
	public static Item findByGroupId_First(long groupId,
		OrderByComparator<Item> orderByComparator)
		throws net.indaba.lostandfound.exception.NoSuchItemException {
	...
	* @return the first matching item, or <code>null</code> if a matching item could not be found
	*/
	public static Item fetchByGroupId_First(long groupId,
		OrderByComparator<Item> orderByComparator) {
	...
	* @throws NoSuchItemException if a matching item could not be found
	*/
	public static Item findByGroupId_Last(long groupId,
		OrderByComparator<Item> orderByComparator)
		throws net.indaba.lostandfound.exception.NoSuchItemException {
	...
	* @return the last matching item, or <code>null</code> if a matching item could not be found
	*/
	public static Item fetchByGroupId_Last(long groupId,
		OrderByComparator<Item> orderByComparator) {
	...
	* @throws NoSuchItemException if a item with the primary key could not be found
	*/
	public static Item[] findByGroupId_PrevAndNext(long itemId, long groupId,
		OrderByComparator<Item> orderByComparator)
		throws net.indaba.lostandfound.exception.NoSuchItemException {
		return getPersistence()
	...
	*/
	public static List<Item> filterFindByGroupId(long groupId) {
	...
	*/
	public static List<Item> filterFindByGroupId(long groupId, int start,
		int end) {
	...
	* @throws NoSuchItemException if a item with the primary key could not be found
	*/
	public static Item[] filterFindByGroupId_PrevAndNext(long itemId,
	...
	*/
	...
	public static ItemPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ItemPersistence)PortletBeanLocatorUtil.locate(net.indaba.lostandfound.service.ClpSerializer.getServletContextName(),
